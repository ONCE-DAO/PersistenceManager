...
import { IOR, OnceMode, ServerSideUcpComponentDescriptorInterface } from "ior:esm:/tla.EAM.Once[dev]";
...
import { UDEObject } from "ior:esm:/tla.EAM.UcpComponent.PersistanceManager[main]";
import { UcpModelChangelog } from "ior:esm:/tla.EAM.UcpComponent[main]";

export default class FilePersistanceManager extends BasePersistanceManager {
